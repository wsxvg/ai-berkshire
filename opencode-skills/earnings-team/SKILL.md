---
name: earnings-team
description: "对 $ARGUMENTS 进行团队化财报精读分析。四位大师并行解读财报，编辑润色成文，读者评审把关质量，最终产出可直接发布的公众号文章。"
user-invocable: true
---
## OpenCode adapter note

This skill is generated from `skills/earnings-team.md` — the canonical source.
