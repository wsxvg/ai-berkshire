# 京东金融 H5 / PC 端 API 完整挖掘报告 (jdjr.jd.com)
...
| `gw2/generic/touchFish/h5/m/getPlateRank` | POST | ✅ **板块排行** (行业/概念涨跌幅), get_plate_rank() |

**queryFullRanking** 端点 (已文档化在 docs/demo.md) - 重要!

**🆕 2026-07-15 新增端点 (111.txt 抓包)**:
| `gw2/generic/wealthBase/newh5/m/getIndexHistoryWinRate` | POST | 指数历史胜率 ⚠️ status=FAIL |
| `gw2/generic/wealthBase/newh5/m/getIndexRelatedFund` | POST | 指数关联基金 ⚠️ status=FAIL |
| `gw2/generic/wealthBase/newh5/m/getIndexTradeHot` | POST | 指数交易热度 ⚠️ status=FAIL |
| `gw2/generic/wealthBase/newh5/m/getIndexNews` | POST | 指数新闻 ⚠️ status=FAIL |
| `gw2/generic/opdataapi/h5/m/getTimeSharingDots` | POST | 分时图数据点 ⚠️ 返回空 |
