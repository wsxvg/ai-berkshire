...
**最佳 (Walk-Forward 验证)**: V8_HOLD9, +4.845% 每季度 (~+21% 年化) ✅ **跑赢沪深300**

| 阶段 | 季度收益 | 改进来源 |
|------|----------|----------|
| V8 初代 | -0.37% | 过拟合 |
| EXP_MOM | +0.33% | 简单专家信号 |
| MOM_24_TP7 | +0.989% | TP 优化至 7% |
| V8 消融单回测 | +97.47% (3yr) | 五维权重 + TP50 |
| **V8_HOLD9 WF** | **+4.845%** | **28 窗口 walk-forward** |
| **年化** | **≈21%** | **跑赢 CSI300 (≈8-10%) ✅** |
